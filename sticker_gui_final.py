...
class Sticker:
    ...
    def check_angle(self):
        ...
        self.sys_result_label.setText("불량품 세트"  if err_cnt > 2 else "no sticker" if stk_cnt != 10 else "정상 세트")
        self.check_barcode()

    def check_barcode(self):
        for bcd in self.barcode_img:
            idx = bcd[0]
            box = bcd[1]
            ...
            tmp = cropped_bcd_img[box_y + barcode_height : box_height, box_x : box_x + barcode_width]
